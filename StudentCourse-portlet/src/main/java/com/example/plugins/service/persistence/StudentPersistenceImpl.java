...
import com.example.plugins.NoSuchStudentException;
import com.example.plugins.model.Student;
import com.example.plugins.model.impl.StudentImpl;
import com.example.plugins.model.impl.StudentModelImpl;
...
public class StudentPersistenceImpl extends BasePersistenceImpl<Student>
    ...
    protected TableMapper<Student, com.example.plugins.model.Course> studentToCourseTableMapper;
     ...
     * @throws com.example.plugins.NoSuchStudentException if a student with the primary key could not be found
    ...
    @Override
    public Student updateImpl(com.example.plugins.model.Student student)
    ...
    /**
     * Returns the student with the primary key or throws a {@link com.example.plugins.NoSuchStudentException} if it could not be found.
     *
     * @param studentId the primary key of the student
     * @return the student
     * @throws com.example.plugins.NoSuchStudentException if a student with the primary key could not be found
     ...
     */
    @Override
    public List<com.example.plugins.model.Course> getCourses(long pk)
        throws SystemException {
     ...
     */
    @Override
    public void addCourse(long pk, com.example.plugins.model.Course course)
        throws SystemException {
    ...
    public void addCourses(long pk,
        List<com.example.plugins.model.Course> courses)
        throws SystemException {
        for (com.example.plugins.model.Course course : courses) {
     ...
     */
    @Override
    public void removeCourse(long pk, com.example.plugins.model.Course course)
        throws SystemException {
    ...
    public void setCourses(long pk,
        ...
        try {
            ...
            for (int i = 0; i < courses.size(); i++) {
                com.example.plugins.model.Course course = courses.get(i);
            ...
            FinderCacheUtil.clearCache(StudentModelImpl.MAPPING_TABLE_STUDENTCOURSE_COURSES_STUDENTS_NAME);
        }
    }
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.example.plugins.model.Student")));
        ...
        studentToCourseTableMapper = TableMapperFactory.getTableMapper("StudentCourse_Courses_Students",
                "studentId", "courseId", this, coursePersistence);
    }
