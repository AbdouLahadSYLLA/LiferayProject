...
import com.example.plugins.service.StudentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.example.plugins.service.impl.StudentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.example.plugins.service.impl.StudentLocalServiceImpl
 * @see com.example.plugins.service.StudentLocalServiceUtil
 * @generated
 */
public abstract class StudentLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    @BeanReference(type = com.example.plugins.service.CourseLocalService.class)
    protected com.example.plugins.service.CourseLocalService courseLocalService;
    @BeanReference(type = com.example.plugins.service.CourseService.class)
    protected com.example.plugins.service.CourseService courseService;
    @BeanReference(type = CoursePersistence.class)
    protected CoursePersistence coursePersistence;
    @BeanReference(type = com.example.plugins.service.StudentLocalService.class)
    protected com.example.plugins.service.StudentLocalService studentLocalService;
    @BeanReference(type = com.example.plugins.service.StudentService.class)
    protected com.example.plugins.service.StudentService studentService;
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.example.plugins.service.StudentLocalServiceUtil} to access the student local service.
     */
     ...
     */
    @Override
    public void clearCourseStudents(long courseId) throws SystemException {
    ...
    public List<Student> getCourseStudents(long courseId)
        throws SystemException {
        return coursePersistence.getStudents(courseId);
    }
    ...
    public List<Student> getCourseStudents(long courseId, int start, int end)
        throws SystemException {
        return coursePersistence.getStudents(courseId, start, end);
    }
     ...
     */
    @Override
    public int getCourseStudentsCount(long courseId) throws SystemException {
     ...
     */
    @Override
    public boolean hasCourseStudents(long courseId) throws SystemException {
     ...
     */
    public com.example.plugins.service.CourseLocalService getCourseLocalService() {
    ...
    public void setCourseLocalService(
        com.example.plugins.service.CourseLocalService courseLocalService) {
     ...
     */
    public com.example.plugins.service.CourseService getCourseService() {
    ...
    public void setCourseService(
        com.example.plugins.service.CourseService courseService) {
     ...
     */
    public com.example.plugins.service.StudentLocalService getStudentLocalService() {
    ...
    public void setStudentLocalService(
        com.example.plugins.service.StudentLocalService studentLocalService) {
     ...
     */
    public com.example.plugins.service.StudentService getStudentService() {
    ...
    public void setStudentService(
        com.example.plugins.service.StudentService studentService) {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.example.plugins.model.Student",
            studentLocalService);
    }
