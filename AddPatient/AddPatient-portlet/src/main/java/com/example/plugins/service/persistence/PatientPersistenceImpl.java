...
import com.example.plugins.NoSuchPatientException;
import com.example.plugins.model.Patient;
import com.example.plugins.model.impl.PatientImpl;
import com.example.plugins.model.impl.PatientModelImpl;
import com.example.plugins.service.persistence.PatientPersistence;
...
public class PatientPersistenceImpl extends BasePersistenceImpl<Patient>
    ...
    @Override
    public Patient updateImpl(com.example.plugins.model.Patient patient)
    ...
    protected Patient toUnwrappedModel(Patient patient) {
        ...
        patientImpl.setNom(patient.getNom());
        patientImpl.setPrenom(patient.getPrenom());
        patientImpl.setPatientAge(patient.getPatientAge());
        patientImpl.setPatientGenre(patient.getPatientGenre());
        patientImpl.setPatientAddresse(patient.getPatientAddresse());
        patientImpl.setPatientEmail(patient.getPatientEmail());
    ...
    public void afterPropertiesSet() {
        String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
                    com.liferay.util.service.ServiceProps.get(
                        "value.object.listener.com.example.plugins.model.Patient")));
